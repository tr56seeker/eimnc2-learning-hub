...
export function WelcomeHero({
  ...
  return (
    <section className="overflow-hidden rounded-3xl border border-white/80 bg-[linear-gradient(135deg,rgba(255,255,255,0.96),rgba(240,253,250,0.88)_48%,rgba(239,246,255,0.86))] p-7 shadow-xl shadow-slate-200/50 dark:border-slate-800/80 dark:bg-[linear-gradient(135deg,rgba(15,23,42,0.96),rgba(19,78,74,0.35)_48%,rgba(15,23,42,0.9))] dark:shadow-black/30 sm:p-9">
      <div className="flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-3xl">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-teal-700 dark:text-teal-400">{label}</p>
        ...
        <div className="flex flex-col gap-3 sm:flex-row lg:shrink-0">
          <Link
            ...
            className="inline-flex min-h-12 items-center justify-center rounded-2xl bg-slate-950 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-slate-950/10 hover:-translate-y-0.5 hover:bg-teal-700 dark:bg-teal-600 dark:shadow-black/30 dark:hover:bg-teal-500"
          >
            {primaryAction.label}
          </Link>
          {secondaryAction ? (

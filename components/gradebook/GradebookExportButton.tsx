...
export function GradebookExportButton({
  ...
  return (
    <button
      ...
      className="rounded-2xl border border-teal-200 bg-white/80 px-4 py-2.5 text-sm font-semibold text-teal-700 shadow-sm hover:bg-teal-50 disabled:opacity-60"
    >

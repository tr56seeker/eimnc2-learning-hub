                  ...
                  <Link key={project.id} href={`/teacher/projects/${project.id}`} className="card block rounded-[1.5rem] p-6 hover:-translate-y-0.5 hover:shadow-xl">
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      <div>
                        ...
                        <h3 className="mt-1 text-lg font-semibold text-slate-950">{project.title}</h3>
                      </div>
                      <span className={project.is_active !== false ? "rounded-full bg-teal-50 px-3 py-1 text-xs font-semibold text-teal-700" : "rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-600"}>

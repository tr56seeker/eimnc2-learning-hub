  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-5 py-10">
      <div className="card w-full max-w-md rounded-[1.75rem] p-7 sm:p-9">
        <Link href="/" className="text-xs font-semibold uppercase tracking-[0.2em] text-teal-700 dark:text-teal-400">EIM NC II</Link>
        ...
        <p className="mt-5 text-center text-sm text-slate-500 dark:text-slate-400">
          No account yet? <Link href="/signup" className="font-semibold text-teal-700 hover:text-teal-800 dark:text-teal-400 dark:hover:text-teal-300">Create learner account</Link>
        </p>
      </div>
    </main>
  );
